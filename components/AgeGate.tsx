...
export default function AgeGate() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg rounded-3xl bg-white px-8 py-10 text-neutral-900 shadow-2xl sm:px-10 sm:py-12">
        {status === "asking" ? (
          <>
            ...
            <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:gap-4">
              <button
                type="button"
                onClick={allow}
                className="flex-1 cursor-pointer rounded-md bg-neutral-900 px-4 py-3 text-xs font-semibold tracking-[0.18em] whitespace-nowrap text-white uppercase transition-colors hover:bg-neutral-700"
              >
                Yes, I am 18+
              </button>
              <button
                ...
                className="flex-1 cursor-pointer rounded-md border border-neutral-300 px-4 py-3 text-xs font-semibold tracking-[0.18em] whitespace-nowrap text-neutral-600 uppercase transition-colors hover:border-neutral-500 hover:text-neutral-900"
              >
                No, I am under 18
              </button>
            </div>
